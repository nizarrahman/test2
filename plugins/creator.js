...
if (command == 'owner') {
 let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:WhatsApp;Saya Owner Nizar Rahman;Bot;;Md\nFN:Saya Owner Nizar Rahman Dev Bot WhatsApp, Md\nNICKNAME:👑 Owner Nizar Rahman Bot\nORG:Wudy\nTITLE:soft\nitem1.TEL;waid=6281386945391:+62 813-8694-5391\nitem1.X-ABLabel:📞 Nomor Owner\nitem2.URL:https://nizarrahman.000webhostapp.com\nitem2.X-ABLabel:💬 More\nitem3.EMAIL;type=INTERNET:rnizar221@gmail.com\nitem3.X-ABLabel:💌 Mail Owner Nizar Rahman\nitem4.ADR:;;🇮🇩 Indonesia;;;;\nitem4.X-ABADR:💬 More\nitem4.X-ABLabel:📍 Lokasi Saya\nBDAY;value=date:🔖 02 November 2005\nEND:VCARD`
...
if (command == 'creator') {
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `rnizar221@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://nizarrahman.000webhostapp.com/`, `👤 Gada pawang nih senggol dong 😔`],
